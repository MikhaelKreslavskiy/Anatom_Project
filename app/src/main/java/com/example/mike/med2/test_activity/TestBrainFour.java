...
public class TestBrainFour extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        question.setText("Орган дыхательной системы?");
        switch (testCont.randomer()) {
            case 0:
                ...
                right.setText("легкое");
                bad1.setText("сердце");
                bad2.setText("печень");
                bad3.setText("мочеточник");
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick( View v) {
                ...
                Intent intent =new Intent(TestBrainFour.this,TestBrainFive.class);
