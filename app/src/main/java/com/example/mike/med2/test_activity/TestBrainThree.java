...
public class TestBrainThree extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch (testCont.randomer()) {
            case 0:
                ...
                right.setText("Ливанов");
                bad1.setText("Бенедикт");
                bad2.setText("Роберт");
                bad3.setText("Ватсон");
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick( View v) {
                ...
                Toast.makeText(getApplicationContext(), "Yes"+ testCont.result, Toast.LENGTH_LONG).show();
                 ...
                 Intent intent =new Intent(TestBrainThree.this,TestBrainFour.class);
